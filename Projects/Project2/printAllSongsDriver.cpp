...
/*  
    PSUDO CODE:
        1. Check to see if there are any songs stored in the array
        2. If there are, cycle through every song
        3. Get artist and title of the song
        4. Output it to the user in correce format
        5. Return is Void
*/
